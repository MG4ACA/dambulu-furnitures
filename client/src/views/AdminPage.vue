          ...
          <div class="p-6 border-b border-gray-100">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <p class="text-oak-light text-sm">Add, edit, or remove products from your catalog</p>
              </div>
              <Button 
            ...
            <Column field="name" header="Product Name" sortable style="min-width: 200px">
              <template #body="slotProps">
                <div>
                  ...
                  <p class="text-oak-light text-sm truncate max-w-xs">{{ slotProps.data.shortDescription }}</p>
                </div>
              </template>
            </Column>
            ...
            <Column field="isBestSeller" header="Status" style="width: 120px">
              <template #body="slotProps">
                <div class="flex flex-col gap-1">
                  ...
                  <Tag v-if="slotProps.data.inStock === false" value="Out of Stock" severity="danger" />
                </div>
              </template>
            </Column>
...
import { productService, categories } from '@/services/api'
...
const openAddDialog = () => {
  ...
  productForm.value = { ...defaultProductForm, dimensions: { width: null, height: null, depth: null } }
  errors.value = {}
  uploadedFiles.value = []
