  ...
  const products = [
    {
      ...
      category: 'Sofas',
      category_code: 'sofas',
      short_description: 'Elegant 7-seater sofa set with premium teak wood frame and plush cushions',
      description: 'Experience luxury living with our Royal Heritage Sofa Set. Crafted from premium teak wood with hand-carved details.',
      full_description: 'Experience luxury living with our Royal Heritage Sofa Set. Crafted from premium teak wood with hand-carved details, this stunning 7-seater set includes a 3-seater sofa, two 2-seater sofas, and matching coffee table.',
      price: 185000,
      ...
      weight: 85,
      features: JSON.stringify(['Premium teak wood frame', 'High-density foam cushions', 'Hand-carved details', 'Includes coffee table']),
      is_best_seller: true,
      is_new: false,
      in_stock: true,
      rating: 5.0,
    ...
    },
    {
      ...
      full_description: 'Transform your bedroom into a royal retreat with our Colonial Bedroom Suite. This comprehensive set includes a stunning king-size bed with intricate headboard carving, two matching bedside tables, a spacious 3-door wardrobe, and an elegant dressing table with mirror.',
      price: 325000,
      ...
      weight: 250,
      features: JSON.stringify(['King-size bed with carved headboard', 'Two bedside tables', '3-door wardrobe with mirror', 'Dressing table included']),
      is_best_seller: true,
      is_new: false,
      in_stock: true,
      rating: 5.0,
    ...
    },
    {
      ...
      full_description: 'Gather your family around our magnificent Heritage Dining Table. This 8-seater masterpiece is crafted from solid jak wood, featuring a stunning grain pattern and robust construction.',
      price: 145000,
      original_price: null,
      images: JSON.stringify([
      ...
      weight: 120,
      features: JSON.stringify(['Solid jak wood construction', '8 matching chairs included', 'Extendable design', 'Scratch-resistant finish']),
      is_best_seller: true,
      is_new: false,
      in_stock: true,
      rating: 4.5,
    ...
    },
    {
      ...
      full_description: 'Organize your wardrobe in style with our Classic Teak Almirah. This spacious 4-door unit features a full-length mirror, multiple shelves, hanging space, and dedicated drawers.',
      price: 95000,
      ...
      weight: 150,
      features: JSON.stringify(['Full-length mirror', 'Adjustable shelving', 'Built-in drawers', 'Anti-termite treated']),
    ...
    },
    {
      ...
      full_description: 'Enjoy the outdoors with our Veranda Relaxer Chair Set. Designed for durability and comfort, these chairs feature ergonomic backs and weather-resistant finish.',
      price: 68000,
      original_price: null,
      images: JSON.stringify([
      ...
      weight: 45,
      features: JSON.stringify(['Set of 4 chairs + table', 'Weather-resistant', 'Ergonomic design', 'UV protected']),
      is_best_seller: false,
      is_new: false,
      in_stock: true,
      rating: 4.0,
    ...
    },
    {
      ...
      full_description: 'Make a statement in your office with our Executive Office Desk. This L-shaped desk combines functionality with elegance.',
      price: 125000,
      original_price: null,
      images: JSON.stringify([
      ...
      weight: 95,
      features: JSON.stringify(['L-shaped design', 'Cable management', 'Lockable drawers', 'Leather desk pad included']),
      is_best_seller: false,
      is_new: true,
      in_stock: true,
      rating: 5.0,
    ...
    },
    {
      ...
      full_description: 'Elevate your living room with our Modern TV Console. This wall-mounted unit features a floating design and ample hidden storage.',
      price: 78000,
      original_price: null,
      images: JSON.stringify([
      ...
      finish: 'PU Coating',
      weight: 55,
      features: JSON.stringify(['Wall-mounted floating design', 'Hidden cable management', 'Soft-close cabinets', 'Up to 65" TV support']),
      is_best_seller: false,
      is_new: true,
      in_stock: true,
      rating: 4.5,
    ...
    },
    {
      ...
      full_description: 'Showcase your treasures in our Antique Reproduction Cabinet. This meticulously handcrafted piece features intricate woodwork and beveled glass doors.',
      price: 135000,
      original_price: null,
      images: JSON.stringify([
      ...
      weight: 110,
      features: JSON.stringify(['Beveled glass doors', 'Authentic brass hardware', 'Adjustable glass shelves', 'Lock and key included']),
      is_best_seller: true,
      is_new: false,
      in_stock: true,
      rating: 5.0,
